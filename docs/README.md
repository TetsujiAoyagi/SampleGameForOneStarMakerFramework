...
| `BUILD_SYSTEM_REBUILD_PROGRAM.md` | BuildSystem刷新の全体順序・現在地・AssetDescription拡張・不在時の継続開発方針 | U66/CD0/BS1/BS2a/BS2b/BS2c/BS3完了。次はBS4→DIST→RET。各slice着手時HANDOFFの入力正本。RET Phase Dでharvestして削除する |
