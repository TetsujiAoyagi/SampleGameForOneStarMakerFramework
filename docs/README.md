...
| `S-4_FULL_SPEC_WORLD_AUTHORING.md` | S-4a〜d の制作分業、Lighting、VFX、Events、Whitebox Variant の program 計画 | S-4a〜d 着手時 HANDOFF の入力正本。S-4d の Phase D で harvest して削除する |
| `S-4A_RUNTIME_VARIANT_WORKSPACE.md` | S-4a の Runtime Variant、職種 companion、World Workspace の slice HANDOFF | Phase A の freeze candidate。発注者が凍結するまで Phase B へ進めない |
