...
| `BUILD_SYSTEM_ASSET_DESCRIPTION_EXTENSION.md` | BS2b〜BS4と将来のPrefab / Texture / Mesh Variant拡張の境界・検証時期 | BS2bのPhase A入力。個別Descriptionは実需要時。BS4 Phase Dまたは前提変更時に残課題を移送しharvestして削除する |
