...
Residual risks are empirical: reparse-point behavior, the exception-throwing Content build path, and quarantine failure are unmeasured, as are all native load/build cases. CD0 tests passed 10/10 and full EditMode passed 689/689 against the final implementation bytes.
