...
- Final `pwsh tools/run-tests.ps1 -Filter CD0Spike.Tests`: passed 8/8, failed 0, skipped 0. Raw XML and Unity log are stored beside this file.
- Final `pwsh tools/run-tests.ps1` full EditMode regression against the final implementation bytes: passed 687/687, failed 0, skipped 0. Raw XML and Unity log are stored beside this file.
