...
| §30 | 意味アイデンティティ層（番地付けと命名。構想・契約固定） | [30-accessibility-identity.md](Docs/Architecture/30-accessibility-identity.md) |
| §31 | アクセシビリティ出力予算と調停（構想・契約固定） | [31-accessibility-output-budget.md](Docs/Architecture/31-accessibility-output-budget.md) |
| §32 | アクセシビリティ入力自由度の低減（構想・契約固定） | [32-accessibility-input-dof.md](Docs/Architecture/32-accessibility-input-dof.md) |
