...
namespace SampleGame.DependOnAll
{
    ...
    public sealed class GameSceneFactory : ISceneFactory
    {
        ...
        public SceneBase? CreateSceneClass(SceneResource sceneResource, ISceneQuery sceneQuery, ISceneController sceneController)
        {
            ...
            {
                return new InGame.World.CellCompanionScene(sceneResource, sceneQuery, sceneController, _loggerFactory);
            }
            ...
            return sceneResource.Identity switch
            {
                ...
                "InGameSession" => new InGame.InGameSession(
                    sceneResource,
                    sceneQuery,
                    sceneController,
                    _loggerFactory,
                ...
                // 季節枝。構造分類（StreamByDistance / companion）は上の分岐で先に見る。
                "Season_Spring" => new InGame.World.SeasonScene(sceneResource, sceneQuery, sceneController, _loggerFactory),
