...
namespace OneStarMaker.Tests.SceneSystem
{
    ...
    {
        [UnityTest]
        public IEnumerator AddScene_DuplicateCall_Skips() => UniTask.ToCoroutine(async () =>
        {
        ...
        [UnityTest]
        public IEnumerator UnloadScene_AlreadyUnloading_Skips() => UniTask.ToCoroutine(async () =>
        {
            var director = SetupSingleScene();
            await director.AddScene("TestScene", null, CancellationToken.None);
